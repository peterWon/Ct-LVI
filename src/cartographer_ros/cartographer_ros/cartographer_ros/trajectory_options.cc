...
TrajectoryOptions CreateTrajectoryOptions(
  ...
  options.use_image = lua_parameter_dictionary->GetBool("use_image");
  options.use_compressed_image = lua_parameter_dictionary->GetBool("use_compressed_image");
  ...
  options.image_sampling_ratio =
      lua_parameter_dictionary->GetDouble("image_sampling_ratio");
...
bool FromRosMessage(const cartographer_ros_msgs::TrajectoryOptions& msg,
  ...
  options->use_image = msg.use_image;
  options->use_compressed_image = msg.use_compressed_image;
  ...
  options->image_sampling_ratio = msg.image_sampling_ratio;
...
cartographer_ros_msgs::TrajectoryOptions ToRosMessage(
  ...
  msg.use_image = options.use_image;
  msg.use_compressed_image = options.use_compressed_image;
  ...
  msg.image_sampling_ratio = options.image_sampling_ratio;
