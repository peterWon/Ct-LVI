...
options = {
  ...
  -- only one of these two option can be set to true 
  use_image = false,
  -- TODO, remove it
  ...
  -- if running the offline node, set it to true
  enable_cache_range_data = false,
  ...
  -- keep real ratio, or tracking will fail. sampling after tracking instead.
  image_sampling_ratio = 1.,
}
-- ============================================
...
POSE_GRAPH.constraint_builder.cv_structure_element_size = 7
...
POSE_GRAPH.constraint_builder.scale_estimated_tolerance = 0.1

-- parameters for adding visual keyframes. 
-- the coarse ones for loop closure detection
-- the fine ones for loop frame localization
POSE_GRAPH.loop_position_threshold_coarse = 1.5
...
TRAJECTORY_BUILDER_3D.lvio_config_filename = "/home/wz/study_hub/ros_env/ct-lvio/src/dlio/config/liosam-campus-calib.yaml"
POSE_GRAPH.camera_intrinsics_filename = "/home/wz/study_hub/ros_env/ct-lvio/src/dlio/config/liosam-campus-calib.yaml"
POSE_GRAPH.dbow_voc_filename = "/home/wz/study_hub/ros_env/ct-lvio/orbvoc.dbow3"
