...
class Estimator{
public:
  Estimator(const ParameterServer* ps, 
  ...
  void setReloFrame(double _frame_stamp, 
                    int _frame_index, vector<Vector3d> &_match_points, 
...
// private:
  ...
  std::shared_ptr<FeatureManager> f_manager;
  ...
  // align with the 'local' frame of cartographer
  std::map<double, State> states_in_local_;
  Eigen::Matrix4d T_v2l_;
