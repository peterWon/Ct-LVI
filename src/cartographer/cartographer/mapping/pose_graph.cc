...
proto::PoseGraphOptions CreatePoseGraphOptions(
  ...
  *options.mutable_optimization_problem_options() =
  ...
  options.set_camera_intrinsics_filename(
      parameter_dictionary->GetString("camera_intrinsics_filename"));
  options.set_dbow_voc_filename(
      parameter_dictionary->GetString("dbow_voc_filename"));
  options.set_enable_so3_visual_loop_search(
      parameter_dictionary->GetBool("enable_so3_visual_loop_search"));
  options.set_loop_position_threshold_coarse(
      parameter_dictionary->GetDouble("loop_position_threshold_coarse"));
  options.set_loop_rotation_threshold_coarse(
      parameter_dictionary->GetDouble("loop_rotation_threshold_coarse"));
  options.set_loop_position_threshold_fine(
      parameter_dictionary->GetDouble("loop_position_threshold_fine"));
  options.set_loop_rotation_threshold_fine(
      parameter_dictionary->GetDouble("loop_rotation_threshold_fine"));
  return options;
}
