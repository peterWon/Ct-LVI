...
#include "cartographer/mapping/internal/3d/scan_context/nanoflann.hpp"
#include "cartographer/mapping/internal/3d/scan_context/KDTreeVectorOfVectorsAdaptor.h"
...
public: 
    ...
    // User-side API
    int makeAndSaveScancontextAndKeys( pcl::PointCloud<SCPointType> & _scan_down );
